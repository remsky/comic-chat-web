/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 55edea0a21bf32d979ab93c7364b373c)
// Runtime types generated with workerd@1.20260714.1 2026-07-01 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	ROOMS: ["lobby","pen-pals","dial-up","crack-a-joke"];
	AUTH_REQUIRED: string;
	CLERK_PUBLISHABLE_KEY: string;
	CLERK_SECRET_KEY: string;
	ANON_ROOMS: string;
	CHAT_ROOM: DurableObjectNamespace<import("./worker/index").ChatRoomDO>;
	ROOM_DIRECTORY: DurableObjectNamespace<import("./worker/index").RoomDirectoryDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ChatRoomDO" | "RoomDirectoryDO";
	}
