...
These three match the cast's own line work. A strip built from these plus blank panels is fully black-and-white inkwork. Classic recognizable style. 
...
| room | a still interior with one huge arched window onto rolling hills, an narrow clover or trèfle shaped door in the right background, hatched walls and floor | still and a little strange; waiting. Reads dreamlike and slightly empty. It is somewhat like a den in black inkwork style. |

## Colour

| backdrop | look | use |
| --- | --- | --- |
| clouds | soft airbrushed blue sky with white cloud banks, only the sky in frame | calm, hopeful, optimism, a daydream. |
