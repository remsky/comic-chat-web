// Text metrics adapter over any measure context. Engine geometry remains in v1 logical units.
...
function canvasSafeText(text: string): string {
	// GDI's explicit trailing NUL has no advance; canvas otherwise renders a replacement glyph in some engines
